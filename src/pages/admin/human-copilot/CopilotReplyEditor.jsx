...
import { getDeliveryStatusLabel, getDeliveryStatusTone, normalizeDeliveryStatus, PANEL_CLASS } from './copilotUtils';
      ...
      <section className={shellClass}>
        ...
        <div className="flex items-end gap-2">
          ...
          <div className="flex shrink-0 flex-col items-center gap-1.5">
            {deliveryLabel ? (
              <span
                className={`max-w-[5.5rem] truncate rounded-full border px-2 py-0.5 text-center text-[9px] font-medium leading-tight ${deliveryTone}`}
                title={deliveryLabel}
              >
                {deliveryLabel}
              </span>
