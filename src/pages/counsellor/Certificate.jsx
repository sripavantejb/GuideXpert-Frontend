...
export default function Certificate() {
  ...
  const { displayName, displayPhone, validationPhone, hasActivation, hasIdentity, usedSettingsOverride } = identity;
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      <p className="text-gray-600 mb-6">Your poster uses the name and phone number on your counsellor profile. Update them anytime in <Link to="/counsellor/settings" className="text-primary-navy underline font-medium">Settings</Link>, then return here to download.</p>
        ...
        <div className="space-y-4">
          ...
          {!hasActivation ? (
            <div className="rounded-md bg-red-50 border border-red-200 px-3 py-2 text-sm text-red-800">
              We could not find your activation form details. Please complete the activation form to download this poster.
            </div>
          ) : (
            <>
