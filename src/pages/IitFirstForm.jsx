...
export default function IitFirstForm() {
  ...
  const handleSubmitInterest = async (e) => {
    ...
    if (answer.length > 2000) {
      setSubmitError('Please keep your answer to 2000 characters or fewer.');
      return;
    }
      ...
      <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-6 sm:p-8">
        ...
        {done ? (
          ...
          <>
            ...
            {step === 3 && (
              <>
                <h2 className="text-lg font-semibold text-gray-900 mb-1">One quick question</h2>
                <p className="text-sm text-gray-600 mb-6">Are you interested to learn more about AI?</p>
              </>
            )}
