...
export const SESSIONS = [
  ...
  },
  {
    ...
    durationMinutes: 10,
    type: 'Compliance',
    videoUrl: 'https://www.youtube.com/watch?v=8sbfLFGrVXc',
    isYoutube: true,
    thumbnail: 'https://img.youtube.com/vi/8sbfLFGrVXc/hqdefault.jpg',
    description: {
  ...
  },
  {
    ...
    durationMinutes: 15,
    type: 'Compliance',
    videoUrl: 'https://www.youtube.com/watch?v=dTKu4bi6ULg',
    isYoutube: true,
    thumbnail: 'https://img.youtube.com/vi/dTKu4bi6ULg/hqdefault.jpg',
    description: {
  ...
  // Day 2 — Session 4: How to Position Yourself as a Trusted Career Counsellor
  {
    ...
    durationMinutes: 14,
    type: 'Compliance',
    videoUrl: 'https://www.youtube.com/watch?v=Sh_iof4v5dk&feature=youtu.be',
    isYoutube: true,
    thumbnail: 'https://img.youtube.com/vi/Sh_iof4v5dk/hqdefault.jpg',
    description: {
