/**
 * Webinar Assessment 1 questions from Training workflow CSV (first section).
 * Mission, Information vs Guidance, counselling approach, role of Counselling.
 */
export const WEBINAR_ASSESSMENT_1_QUESTIONS = [
  {
    id: 'q1',
    type: 'mcq',
