...
export default function WebinarAssessment2({ onComplete }) {
  ...
  const [answers, setAnswers] = useState(() => {
    const initial = {};
    WEBINAR_ASSESSMENT_2_QUESTIONS.forEach((q) => {
      initial[q.id] = '';
    });
    return initial;
  });
  ...
  const questions = WEBINAR_ASSESSMENT_2_QUESTIONS;
    ...
    return (
      <div className="flex flex-col h-full min-h-0">
        <div className="flex flex-col items-center px-6 py-6 text-center">
          ...
          <h2 className="text-xl font-semibold text-primary-navy">Assessment 2 completed</h2>
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      <div className="shrink-0 px-1 pb-4">
        <h2 className="text-lg font-semibold text-gray-800">Assessment 2</h2>
