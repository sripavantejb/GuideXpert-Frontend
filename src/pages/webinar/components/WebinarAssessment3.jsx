...
export default function WebinarAssessment3({ onComplete, nextLabel, onGoNext }) {
  const [questionIndex, setQuestionIndex] = useState(0);
  const [answers, setAnswers] = useState(() => {
    const initial = {};
    WEBINAR_ASSESSMENT_3_QUESTIONS.forEach((q) => {
      initial[q.id] = '';
    });
    return initial;
  });
  ...
  const questions = WEBINAR_ASSESSMENT_3_QUESTIONS;
    ...
    return (
      <div className="flex flex-col h-full min-h-0">
        <div className="flex flex-col items-center px-6 py-6 text-center">
          ...
          <h2 className="text-xl font-semibold text-primary-navy">Assessment 3 completed</h2>
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      <div className="shrink-0 px-1 pb-4">
        <h2 className="text-lg font-semibold text-gray-800">Assessment 3</h2>
