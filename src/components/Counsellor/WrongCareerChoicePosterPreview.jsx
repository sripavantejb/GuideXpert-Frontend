...
/** Matches public/wrong-career-choice-poster.svg viewBox (0 0 810 1012.49997). */
const WIDTH = 810;
const HEIGHT = 1012.5;
const NAME_MAX_LEN = 50;

const FallbackWrongCareerChoiceSvg = () => (
  <svg
...
const WrongCareerChoicePosterPreview = forwardRef(function WrongCareerChoicePosterPreview(
  ...
  return (
    ...
    >
      <FallbackWrongCareerChoiceSvg />
      {!imageError && (
        <img
          src="/wrong-career-choice-poster.svg"
          alt=""
          onLoad={() => {
            setImageLoaded(true);
...
export default WrongCareerChoicePosterPreview;
export {
  WIDTH as WRONG_CAREER_CHOICE_POSTER_WIDTH,
  HEIGHT as WRONG_CAREER_CHOICE_POSTER_HEIGHT,
};

export const WRONG_CAREER_CHOICE_POSTER_EXPORT_LAYOUT = {
  name: {
    x: NAME_ANCHOR.x,
    y: NAME_ANCHOR.y,
