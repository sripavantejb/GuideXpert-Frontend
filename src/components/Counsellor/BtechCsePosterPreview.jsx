...
/** Matches public/btechcse-poster.svg viewBox (0 0 810 ~810). */
const WIDTH = 810;
const HEIGHT = 810;
const NAME_MAX_LEN = 50;

const FallbackBtechCseSvg = () => (
  <svg
...
/** Bottom-right name / phone; tune after visual QA if layout differs from SID. */
const BTECH_CSE_POSTER_ACCENT = '#fd8002';
const NAME_ANCHOR = { x: 768, y: 677, maxWidth: 330, fontSize: 24, fontWeight: 600, color: BTECH_CSE_POSTER_ACCENT };
const PHONE_ANCHOR = { x: 768, y: 711, maxWidth: 290, fontSize: 22, fontWeight: 600, color: BTECH_CSE_POSTER_ACCENT };

const BtechCsePosterPreview = forwardRef(function BtechCsePosterPreview(
...
export default BtechCsePosterPreview;
export { WIDTH as BTECH_CSE_POSTER_WIDTH, HEIGHT as BTECH_CSE_POSTER_HEIGHT };

export const BTECH_CSE_POSTER_EXPORT_LAYOUT = {
  name: {
    x: NAME_ANCHOR.x,
    y: NAME_ANCHOR.y,
