...
/**
 * TNEA 2026 — single-screen filters: rank, category, all/specific TN districts & branches, native place, sort.
 * Wire values to `admission_category_name_enum: DEFAULT` on the API (see collegePredictorOptions TNEA meta).
 */
export default function TneaPredictorForm({
  values,
  onChange,
  onSubmit,
  loading,
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3 mb-4">
        <div>
          <h3 className="text-base font-bold text-gray-900">TNEA 2026 Rank</h3>
          <p className="mt-1 text-xs text-gray-500 max-w-xl">
            One last step: fill your home state and district to contextualize results; college matching uses
            your rank, category, and optional Tamil Nadu district and branch filters.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">
            Enter Your Expected TNEA 2026 Rank <span className="text-red-500">*</span>
          </label>
          <input
            type="number"
            min={1}
