...
/** Matches public/jee-poster.svg viewBox (0 0 810 ~1012). */
const WIDTH = 810;
const HEIGHT = 1012;
const NAME_MAX_LEN = 50;

const FallbackJeeSvg = () => (
  <svg
...
/** Bottom-right name / phone — tuned for JEE portrait art; nudge x/y/color after visual QA. */
const JEE_POSTER_ACCENT = '#fd8002';
const NAME_ANCHOR = { x: 768, y: 878, maxWidth: 330, fontSize: 24, fontWeight: 600, color: JEE_POSTER_ACCENT };
const PHONE_ANCHOR = { x: 768, y: 912, maxWidth: 290, fontSize: 22, fontWeight: 600, color: JEE_POSTER_ACCENT };

const JeePosterPreview = forwardRef(function JeePosterPreview(
...
export default JeePosterPreview;
export { WIDTH as JEE_POSTER_WIDTH, HEIGHT as JEE_POSTER_HEIGHT };

export const JEE_POSTER_EXPORT_LAYOUT = {
  name: {
    x: NAME_ANCHOR.x,
    y: NAME_ANCHOR.y,
