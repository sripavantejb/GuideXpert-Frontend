...
/** Matches public/sid-poster.svg viewBox (0 0 810 ~810). */
const WIDTH = 810;
const HEIGHT = 810;
const NAME_MAX_LEN = 50;

const FallbackSidSvg = () => (
  <svg
...
/** Bottom-right name / phone — above SVG footer (~y 776) so no overlap; color matches poster orange #fd8002. */
const SID_POSTER_ACCENT = '#fd8002';
const NAME_ANCHOR = { x: 768, y: 677, maxWidth: 330, fontSize: 24, fontWeight: 600, color: SID_POSTER_ACCENT };
const PHONE_ANCHOR = { x: 768, y: 711, maxWidth: 290, fontSize: 22, fontWeight: 600, color: SID_POSTER_ACCENT };

const SidPosterPreview = forwardRef(function SidPosterPreview(
...
export default SidPosterPreview;
export { WIDTH as SID_POSTER_WIDTH, HEIGHT as SID_POSTER_HEIGHT };

export const SID_POSTER_EXPORT_LAYOUT = {
  name: {
    x: NAME_ANCHOR.x,
    y: NAME_ANCHOR.y,
