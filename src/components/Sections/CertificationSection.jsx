          ...
          <div className="space-y-6">
            {benefits.map((benefit, index) => (
              <div key={index} className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-10 h-10 bg-primary-blue-600 rounded-full flex items-center justify-center" style={{
          ...
          <div className="flex justify-center">
            <div className="bg-white rounded-lg shadow-xl p-0 max-w-lg w-full overflow-hidden relative" style={{
              ...
              <div className="absolute top-0 left-0 right-0 h-20 overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-primary-blue-200 rounded-full -mr-16 -mt-16 opacity-50"></div>
                <div className="absolute top-0 right-8 w-24 h-24 bg-primary-blue-300 rounded-full -mr-12 -mt-12 opacity-60"></div>
                <div className="absolute top-0 left-0 w-20 h-20 bg-primary-blue-600 transform rotate-45" style={{
              ...
              <div className="absolute bottom-0 left-0 right-0 h-20 overflow-hidden">
                <div className="absolute bottom-0 left-0 w-32 h-32 bg-primary-blue-200 rounded-full -ml-16 -mb-16 opacity-50"></div>
                <div className="absolute bottom-0 left-8 w-24 h-24 bg-primary-blue-300 rounded-full -ml-12 -mb-12 opacity-60"></div>
                <div className="absolute bottom-0 right-0 w-20 h-20 bg-primary-blue-600 transform rotate-45" style={{
              ...
              <div className="relative p-10 text-center">
                ...
                <div className="flex items-center justify-start mb-8">
                  <div className="w-12 h-12 bg-primary-blue-600 transform rotate-45 mr-3" style={{
                    clipPath: 'polygon(50% 0%, 0% 100%, 100% 100%)'
                  }}></div>
                  ...
                  <div className="relative">
                    <div className="w-24 h-24 rounded-full border-4 flex flex-col items-center justify-center bg-white" style={{
                      ...
                      <div className="flex gap-1 mb-1">
                        <FaStar className="w-2 h-2 text-primary-blue-600" />
                        <FaStar className="w-2 h-2 text-primary-blue-600" />
                        <FaStar className="w-2 h-2 text-primary-blue-600" />
                      </div>
                      <div className="text-xs font-bold text-primary-blue-600 mb-1">BEST</div>
                      <div className="text-xs font-bold text-primary-blue-600">AWARD</div>
                    ...
                    <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
                      <div className="w-1 h-6 bg-primary-blue-300 rounded-full"></div>
                      <div className="w-1 h-6 bg-primary-blue-300 rounded-full absolute left-2"></div>
                    </div>
                  </div>
                </div>
