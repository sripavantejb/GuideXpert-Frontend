          ...
          <AnimatedElement variant="scaleIn" delay={0.6} duration={0.6}>
            <div className="flex justify-center">
              ...
              <div className="absolute top-0 left-0 right-0 h-12 sm:h-16 md:h-20 overflow-hidden">
                <div className="absolute top-0 right-0 w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 bg-primary-blue-200 rounded-full -mr-8 sm:-mr-12 md:-mr-16 -mt-8 sm:-mt-12 md:-mt-16 opacity-50"></div>
                <div className="absolute top-0 right-4 sm:right-6 md:right-8 w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-primary-blue-300 rounded-full -mr-8 sm:-mr-10 md:-mr-12 -mt-8 sm:-mt-10 md:-mt-12 opacity-60"></div>
                <div className="absolute top-0 left-0 w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-primary-blue-600 transform rotate-45" style={{
              ...
              <div className="absolute bottom-0 left-0 right-0 h-12 sm:h-16 md:h-20 overflow-hidden">
                <div className="absolute bottom-0 left-0 w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 bg-primary-blue-200 rounded-full -ml-8 sm:-ml-12 md:-ml-16 -mb-8 sm:-mb-12 md:-mb-16 opacity-50"></div>
                <div className="absolute bottom-0 left-4 sm:left-6 md:left-8 w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-primary-blue-300 rounded-full -ml-8 sm:-ml-10 md:-ml-12 -mb-8 sm:-mb-10 md:-mb-12 opacity-60"></div>
                <div className="absolute bottom-0 right-0 w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-primary-blue-600 transform rotate-45" style={{
              ...
              <div className="relative p-4 sm:p-6 md:p-8 lg:p-10 text-center">
                ...
                <div className="flex items-center justify-start mb-4 sm:mb-6 md:mb-8">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-primary-blue-600 transform rotate-45 mr-2 sm:mr-3" style={{
                    clipPath: 'polygon(50% 0%, 0% 100%, 100% 100%)'
                  }}></div>
                ...
                <div className="mb-3 sm:mb-4 relative pr-16 sm:pr-20 md:pr-24">
                  ...
                  {/* Best Award Badge - Responsive positioning */}
                    ...
                    <div className="relative">
                      <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full border-2 sm:border-3 md:border-4 flex flex-col items-center justify-center bg-white" style={{
                        ...
                        <div className="flex gap-0.5 sm:gap-1 mb-0.5 sm:mb-1">
                          <FaStar className="w-1.5 h-1.5 sm:w-2 sm:h-2 text-primary-blue-600" />
                          <FaStar className="w-1.5 h-1.5 sm:w-2 sm:h-2 text-primary-blue-600" />
                          <FaStar className="w-1.5 h-1.5 sm:w-2 sm:h-2 text-primary-blue-600" />
                        </div>
                        <div className="text-[8px] sm:text-[10px] md:text-xs font-bold text-primary-blue-600 mb-0.5 sm:mb-1 leading-tight">BEST</div>
                        <div className="text-[8px] sm:text-[10px] md:text-xs font-bold text-primary-blue-600 leading-tight">AWARD</div>
                      ...
                      <div className="absolute -bottom-1 sm:-bottom-2 left-1/2 transform -translate-x-1/2">
                        <div className="w-0.5 sm:w-1 h-4 sm:h-6 bg-primary-blue-300 rounded-full"></div>
                        <div className="w-0.5 sm:w-1 h-4 sm:h-6 bg-primary-blue-300 rounded-full absolute left-1 sm:left-2"></div>
                      </div>
                    </div>
                  </div>
                </div>
