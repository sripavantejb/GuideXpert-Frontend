...
const navItems = [
  ...
  { to: '/admin/pro-data', label: 'PRO data', icon: FiClipboard, sectionKey: 'pro-data', sidebarPlacement: 'counsellors' },
  ...
  { to: '/admin/training-feedback', label: 'Onboarded counsellors 25-26', icon: FiMessageSquare, sectionKey: 'training-feedback', sidebarPlacement: 'counsellors' },
  { to: '/admin/certified-counsellors-26-27', label: 'Certified counsellors 26-27', icon: FiMessageSquare, sectionKey: 'training-feedback', sidebarPlacement: 'counsellors' },
  ...
  { to: '/admin/college-comparisons', label: 'College comparisons', icon: FiColumns, sectionKey: 'leads', sidebarPlacement: 'students' },
  { to: '/admin/student-workspace-leads', label: 'Student workspace leads', icon: FiUsers, sectionKey: 'leads', sidebarPlacement: 'students' },
