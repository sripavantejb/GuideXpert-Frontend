...
import { FiLayout, FiUsers, FiBarChart2, FiDownload, FiSettings, FiCalendar, FiVideo } from 'react-icons/fi';
...
const navItems = [
  ...
  { to: '/admin/meet-attendance', label: 'Meet Attendance', icon: FiVideo },
