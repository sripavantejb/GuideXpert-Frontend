...
export const DEFAULT_ROUTE_PLACEMENTS = {
  ...
  '/admin/activation-counsellor-meet-attendance': 'counsellors',
  '/admin/pro-data': 'counsellors',
...
export const SIDEBAR_SETTINGS_ITEMS = [
  ...
  { to: '/admin/activation-counsellor-meet-attendance', label: 'Activation counsellor Meet attendance' },
  { to: '/admin/pro-data', label: 'PRO data' },
  ...
  { to: '/admin/nurturing', label: 'Nurturing' },
  { to: '/admin/training-feedback', label: 'Onboarded counsellors 25-26' },
  { to: '/admin/certified-counsellors-26-27', label: 'Certified counsellors 26-27' },
  { to: '/admin/counsellor-occupations', label: 'Counsellors occupations' },
  ...
  { to: '/admin/college-comparisons', label: 'College comparisons' },
  { to: '/admin/posters', label: 'Poster automation' },
  { to: '/admin/assessment-results', label: 'Custom Reports' },
  { to: '/admin/webinar-progress', label: 'Training progress 25-26' },
  { to: '/admin/webinar-progress-26-27', label: 'Training progress 26-27' },
  ...
  { to: '/admin/student-workspace-leads', label: 'Student workspace leads' },
